...
tellraw @s {"text":"[Click here to insert crucial values.]","bold":true,"color":"#FFC300","click_event":{"action":"suggest_command","command":"/function gui.maker:maker/api/func/2 {\"run\":\"\",\"item_modifier\":\"\",\"change_gui\":\"\",\"change_page\":\"\"}"}}
