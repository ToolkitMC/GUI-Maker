...
tellraw @s {"text":"[Click here to insert crucial values.]","bold":true,"color":"#FFC300","clickEvent":{"action":"suggest_command","value":"/function gui.maker:maker/api/func/2 {\"run\":\"\",\"item_modifier\":\"\",\"change_gui\":\"\",\"change_page\":\"\"}"}}
